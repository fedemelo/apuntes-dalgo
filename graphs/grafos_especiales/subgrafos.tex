...
Dicho número de subconjuntos de \(V\) es \(2^n\) por la cardinalidad del conjunto potencia, pues \(|V|=n\) y \(|\mathcal{P}(V)| = 2^n\). Entre ellos, está el subconjunto vacío, que no constituye un grafo. Substrayéndolo, se obtienen \(2^{n}-1\) subconjuntos no vacíos, cada uno de los cuales representa un subgrafo inducido.

No se tiene una fórmula cerrada para contar los subgrafos inducidos módulo isomorfismo de un grafo no completo.
