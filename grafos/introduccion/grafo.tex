...
\begin{definicion}{Grafo}{grafo}
  Un \concept{grafo} \(G\) es un par ordenado de conjuntos disjuntos \((V, E)\) tal que \(V\) es un conjunto no vacío de \concept{vértices} o \concept{nodos} y \(E\) es un conjunto de \concept{aristas} o \concept{arcos} que conectan pares de vértices.
\end{definicion}
...
\begin{center}
  \begin{tikzpicture}[scale=1.2,
    ...
    \draw (a)--(u);
  \end{tikzpicture}
  \captionof{figure}{Ejemplo de un grafo.}
