...
Una primera optimización es utilizar programación dinámica top-down: incluir memoización en la implementación recursiva para eliminar la redundancia que introducen los problemas superpuestos:
\begin{pseudocode}
