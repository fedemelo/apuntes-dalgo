...
\concept{Dividir y conquistar} es la técnica de diseño de algoritmos que formaliza esa idea. Consiste en:
\begin{enumerate}
    \item \concept{Dividir} el problema en subproblemas más pequeños (usualmente en la mitad)
    ...
    \item \concept{Combinar} las soluciones de los subproblemas, obteniendo la solución del problema original. Este último paso no siempre es necesario
\end{enumerate}
