...
Dado un arreglo de números, a un subarreglo contiguo no vacío cuya suma (de sus elementos) es mayor que la de cualquier otro subarreglo contiguo se le denomina un \concept{subarreglo máximo}. El problema de encontrar un subarreglo máximo se define como:
\begin{itemize}
