...
En este algoritmo, solo se realizan las etapas de dividir y conquistar; no es necesario combinar las soluciones. Eso facilita realizar una implementación iterativa de búsqueda binaria:
\begin{pseudocode}
