...
\begin{pseudocode}
función merge_sort(números: arreglo)
    if números.longitud <= 1
        return números
    mitad = números.longitud // 2
    izquierda = merge_sort(números[0..mitad-1])
    derecha = merge_sort(números[mitad..números.longitud-1])
...
\begin{pseudocode}
función combinar(izquierda: arreglo, derecha: arreglo)
