...
\begin{codeblock}[Combinar y contar pares invertidos (en gris: \hyperref[impl:merge]{paso de combinar de merge sort}).][impl:merge_and_count_pares]
...
\begin{codeblock}[Conteo de pares invertidos.][impl:count_inverted_pairs]
\begin{pseudocode}[style=derived]
