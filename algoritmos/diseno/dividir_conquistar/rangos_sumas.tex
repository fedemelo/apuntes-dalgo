...
\begin{codeblock}[Cálculo del arreglo de sumas acumuladas.][impl:rangos_sumas_acumuladas]
\begin{pseudocode}
...
\begin{codeblock}[Combinar y contar sumas de rango (en gris: \hyperref[impl:merge]{paso de combinar de merge sort}).][impl:merge_and_count_rangos]
...
\begin{codeblock}[Conteo de sumas de rango (en gris: \hyperref[impl:count_inverted_pairs]{conteo de pares invertidos}).][impl:count_sum_ranges]
\begin{pseudocode}[style=derived]
