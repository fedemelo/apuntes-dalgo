...
\begin{codeblock}[Subarreglo máximo por fuerza bruta.][impl:subarreglo_max_fuerza_bruta]
\begin{pseudocode}
...
\begin{codeblock}[Subarreglo máximo por fuerza bruta optimizada.][impl:subarreglo_max_fuerza_bruta_2]
\begin{pseudocode}
...
\begin{codeblock}[Subarreglo máximo por dividir y conquistar.][impl:subarreglo_max_divide_conquer]
\begin{pseudocode}
...
\begin{codeblock}[Subarreglo máximo que cruza la mitad.][impl:subarreglo_max_crossing]
\begin{pseudocode}
