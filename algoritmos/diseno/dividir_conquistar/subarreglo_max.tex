...
No obstante, seguía siendo demasiado lento. Grenander le comentó el problema a Shamos, quien se tomó una noche para diseñar el algoritmo que se estudia en la siguiente sección. (\cite{bentley})
...
Ahora sí, se contemplan todos los subarreglos que pasan por donde se dividió el arreglo. Todos esos subarreglos tienen un pedazo a la izquierda de esa mitad y un pedazo a la derecha. Para maximizar la suma, queremos maximizar la de la izquierda y también maximizar la de la derecha. En este caso, usar un algoritmo exhaustivo no es ingenuo: se toma el subarreglo máximo de la izquierda, el máximo de la derecha, y se juntan:
\begin{codeblock}
\begin{pseudocode}
