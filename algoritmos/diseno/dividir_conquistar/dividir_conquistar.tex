...
Muchos problemas pueden dividirse en varios subproblemas más pequeños y esos subproblemas siguen siendo muy similares al problema original (por lo que pueden dividirse de nuevo). Con eso, combinando las soluciones de los subproblemas se puede obtener la solución al problema original.

\concept{Dividir y conquistar} es el paradigma que formaliza esa idea. Consiste en:
\begin{enumerate}
...
\inputlist{merge_sort, subarreglo_max, matrices_strassen, notes}
