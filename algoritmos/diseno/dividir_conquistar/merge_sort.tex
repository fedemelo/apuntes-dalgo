...
Dividir no tiene ciencia: se calcula el índice de la mitad del arreglo para determinar el índices de inicio \inline{lo} y fin \inline{hi} de cada segmento.
...
\end{pseudocode}
\begin{annotations}
    \codebox[xshift=2cm,width=7cm]{mid}{\annMitadSinOverflow{lo}{hi}}
