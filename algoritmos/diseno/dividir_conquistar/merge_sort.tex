...
\begin{codeblock}[Dividir y conquistar de merge sort.][impl:merge_sort]
\begin{pseudocode}
...
\begin{codeblock}[Invocación inicial de merge sort.][impl:merge_sort_invocacion]
\begin{pseudocode}
...
\begin{codeblock}[Paso de combinar de merge sort.][impl:merge]
\begin{pseudocode}
...
\begin{annotations}
    ...
    \codenote[box=true, notepos={(cn@es.east)+(2cm,0.8cm)}, curve={bend left=25}, width=10cm]{es}{\texttt{<=} en lugar de \texttt{<} al comparar los elementos de cada mitad para que haya estabilidad.}
...
\end{forest}
\captionof{figure}{Árbol de ejecución de merge sort para un arreglo de tamaño 8, etiquetado con el tamaño de cada segmento.}
\label{fig:merge_sort_arbol_ejecucion}
\end{center}
...
\practicar[leetcode]{Merge Sorted Array}{https://leetcode.com/problems/merge-sorted-array}
