...
\begin{especificacion}
  ...
  \salida{Los ingresos máximos que se pueden obtener al cortar la vara.}
\end{especificacion}
En ese modelo, \(p[0] = 0\) porque una longitud de \(0\) representa la ausencia de vara (y por ende de venta).
...
\end{pseudocode}
\begin{annotations}
    \codebox[notepos={(cn@mejor.east)+(5cm,0.6cm)}, curve={bend right=5}, width=4.7cm]{mejor}{Se almacena el primer corte que se hizo en la solución óptima de ese subproblema.}
