...
Un \concept{algoritmo} es una secuencia de pasos que transforman un conjunto de valores de \concept{entrada} (\textit{input}) en un conjunto de valores de \concept{salida} (\textit{output}).
\end{definicion}
...
Sin embargo, como es simplemente una secuencia de pasos, también se puede describir el algoritmo con otros medios:
\begin{itemize}
...
\end{itemize}
Es decir, el algoritmo como tal es un objeto matemático abstracto, independiente de su implementación.
