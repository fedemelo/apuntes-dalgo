...
Es evidente que el código se asemeja a Python. Los detalles más recurrentes en estas notas donde el seudocódigo difiere con Python son los siguientes:
\begin{itemize}
...
Por último, un comentario sobre los nombres de variables: se usa \inline{i}, \inline{j}, \inline{k} como contadores de ciclos (de externo a interno), \inline{lo}, \inline{mid}, \inline{hi} para los extremos y el punto medio de un rango, y \inline{l}, \inline{r} para cursores que recorren un rango hacia la izquierda o la derecha. Son abreviaturas ubicuas en la literatura de algoritmos.
