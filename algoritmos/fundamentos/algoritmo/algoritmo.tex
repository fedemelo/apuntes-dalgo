...
Para muchos algoritmos se puede realizar una \concept{implementación}: escribir un programa, usando algún lenguaje de programación en alguna máquina, que ejecuta el algoritmo. Sin embargo, el algoritmo como tal es un objeto matemático abstracto, independiente de su implementación, por lo que también se puede describir mediante:
\begin{itemize}
